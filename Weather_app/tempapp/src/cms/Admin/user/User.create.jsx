...
// listing category in parent dropdown
    const listALLUser = async() => {
        try{
            const list = await userSvc.listAllUserData();
            setListOfUser(list.data.data);
        }catch(exception){
            throw exception
        }
    }
    ...
    return (
        ...
        <div class="container-fluid px-4">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item"><NavLink to="/addmin/users">DashBoard</NavLink></li>
                        <li class="breadcrumb-item"><NavLink to="/addmin/userslist">categorylist</NavLink></li>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select  class="form-control"  {...register('parent', { required: false, value: "active" })} >
                                    ...
                                    {listOfUser && listOfUser.map((cat,index)=>(
